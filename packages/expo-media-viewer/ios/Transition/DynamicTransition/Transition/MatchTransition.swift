...
public class MatchTransition: InteractiveTransition {
    ...
    public var presentedContentFrameProvider: (() -> CGRect?)?
    ...
    public override func canTransitionSimutanously(with transition: ViewerTransition) -> Bool {
    ...
    public override func setupTransition(context: any TransitionContext, animator: TransitionAnimator) {
        ...
        if let matchedSourceView, sourceViewSnapshot != nil || suppressSourceViewSnapshot {
    ...
    func setupAnimation(context: any TransitionContext, animator: TransitionAnimator) {
        ...
        let presentedScaleFrame = presentedContentFrameProvider?() ?? presentedFrame
